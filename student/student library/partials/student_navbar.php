            ...
            <ul class="navbar-nav flex-row">
                <li class="nav-item me-3 me-lg-1">
                    <a class="nav-link d-sm-flex align-items-sm-center" href="#">
                        ...
                        <strong class="d-none d-sm-block ms-1"><?php echo $_SESSION['student_name']; ?></strong>
                    </a>
                </li>
                ...
                <li class="nav-item dropdown me-3 me-lg-1" id="dropdown-arrow-li">
                    ...
                    <ul class="dropdown-menu dropdown-menu-end" aria-labelledby="dropdown-arrow" style="right:0;">
                        ...
                        <li>
                            <a class="dropdown-item" href="#">Your Fine : <?php echo $_SESSION['totalFine']; ?></a>
                        </li>
                        <li>
                            <a class="dropdown-item" href="/libr/student/student library/partials/_handleLogout.php"><i class="bi bi-box-arrow-right"></i> Logout</a>
                        </li>
                    </ul>
                </li>
            </ul>
