            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto mb-lg-0">
                        ...
                        <li class="nav-item">
                            <a class="nav-link" href="../student.php"><i class="fa-solid fa-user-tie"></i> Student</a>
                        </li>
                    </ul>
            ...
            <div class="container-fluid h-custom">
                ...
                <div class="row d-flex justify-content-center align-items-center h-100">
                    <div class="col-md-9 col-lg-6 col-xl-5">
                        <img src="./images/student_login.webp" class="img-fluid" alt="Sample image">
                    </div>
                    <div class="col-md-8 col-lg-6 col-xl-4 offset-xl-1">
                        <form action="/libr/student/partials/_handleStudentLogin.php" method="POST">
                            <!-- Email input -->
                            ...
                            <div class="text-center text-lg-start mt-4 pt-2">
                                ...
                                <p class="small fw-bold mt-2 pt-1 mb-0">Don't have an account? <a href="/libr/student/student signup/student_signup.php" class="link-danger">Register</a></p>
                            </div>
