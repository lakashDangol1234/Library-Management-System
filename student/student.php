...
<body>
    ...
    <main>
        ...
        <div class="login-signup text-center">
            ...
            <a class="btn btn-primary" href="./student signup/student_signup.php">Sign Up</a>
            <a class="btn btn-primary" href="./student login/student_login.php">Login</a>
        <!-- Student Text Ends Here -->
        </div>
    </main>
