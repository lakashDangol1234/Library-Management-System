...
<body>
    ...
    <main>
        <div class="container-fluid mt-5">
            <div class="d-flex justify-content-between">
                <h3 class="mb-3">Expired Book Information</h3>
                <div class="returned_and_expired">
                    <a href="/libr/admin/admin library/expired returned books/expired_and_returned.php" class="btn btn-danger">Expired Books</a>
                    <a href="/libr/admin/admin library/expired returned books/expired_and_returned.php?returnedbooks" class="btn btn-primary">Returned Books</a>
                </div>
            </div>
            <div class="table-responsive">
                <table id="expired_returned_book_info_table" class="table table-bordered align-middle m-auto bg-white table-hover">
                    <thead class="bg-light">
                        <tr id="expired_returned_book_info_table_heading">
                            <th>Student ID</th>
    ...
    <script>
        $(document).ready(function() {
            $('#expired_returned_book_info_table').DataTable();
            let emptyData = document.querySelector('.dataTables_empty');
            if (document.contains(emptyData)) {
                emptyData.innerText = "There is no <?php echo $showData ?> book";
            }
        });
    </script>
</body>
