                            ...
                            <div class="card-body p-md-5">
                                <div class="row justify-content-center">
                                    <div class="col-md-10 col-lg-6 col-xl-5 order-2 order-lg-1">
                                        ...
                                        <form class="mx-1 mx-md-4" action="/libr/admin/partials/_handleAdminSignup.php" method="POST">
                                            ...
                                            <div class="d-flex justify-content-center text-center text-lg-start pt-2 mb-log-4 mb-3">
                                                <p class="small fw-bold mt-2 pt-1 mb-0">Already had an account? <a href="/libr/admin/admin login/admin_login.php" class="link-danger">Login</a></p>
                                            </div>
                                    ...
                                    <div class="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">
                                        ...
                                        <img src="./images/admin_signup.webp" class="img-fluid" alt="Sample image">
